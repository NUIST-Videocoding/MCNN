...
flags.DEFINE_string('input_annotations_boxes', default="E:\whh\VCM\W-MSFC\map\map_util\segmentation_validation_bbox_5k.csv",
                    help='File with groundtruth boxes annotations.')
flags.DEFINE_string('input_annotations_labels', "E:\whh\VCM\W-MSFC\map\map_util\segmentation_validation_labels_5k.csv",
                    'File with groundtruth labels annotations.')
flags.DEFINE_string(
    'input_predictions', "E:\whh\VCM\W-MSFC\map\map_out\ori_seg_oi.txt",
...
#     """File with detection predictions; NOTE: no postprocessing is applied in the evaluation script."""
# )
flags.DEFINE_string('input_class_labelmap', "E:\whh\VCM\W-MSFC\map\map_util\coco_label_map.pbtxt",
                    'Open Images Challenge labelmap.')
flags.DEFINE_string('output_metrics', "E:\whh\VCM\W-MSFC\map\map_out\ori_seg_map.txt", 'Output file with csv metrics.')
flags.DEFINE_string(
    'input_annotations_segm', 'E:\whh\VCM\W-MSFC\map\map_util\segmentation_validation_masks_5k.csv',
