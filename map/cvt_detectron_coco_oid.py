...
parser.add_argument('--coco_output_file', type=str, default=r'/data1/whh/W-MSFC/map/map_out/oid_coco.txt', \
  help='prediction output file in COCO format')
parser.add_argument('--oid_output_file', type=str, default=r'/data1/whh/W-MSFC/map/map_out/oid_oi.txt', \
  help='prediction output file in OpenImages format')
parser.add_argument('--selected_classes', type=str, default=r'/data1/whh/W-MSFC/map/map_util/selected_classes.txt', \
